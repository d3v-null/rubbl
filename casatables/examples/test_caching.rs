...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("=== Testing WITH column caching ===");
    {
        ...
        desc.add_scalar_column(GlueDataType::TpDouble, "TEST_COL", Some("Test column"), false, false)?;
        
        let mut table = Table::new(table_path1, desc, 100, TableCreateMode::New)?;
    ...
    println!("\n=== Testing WITHOUT column caching ===");
    {
        ...
        let mut table = Table::new(table_path2, desc, 100, TableCreateMode::New)?;
